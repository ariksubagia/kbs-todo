...
@section("main")
    ...
    <section class="card-list w-[500px] mx-auto flex-1 flex flex-col gap-3 max-h-full h-full overflow-auto py-5">
        @if(count($todos) <= 0)
            <div class="text-center text-2xl text-gray-500">Belum ada data todo</div>
        @else
